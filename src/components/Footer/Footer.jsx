...
const Footer = () => {
    return (
        ...
        <footer className="bg-gray-900 ">
            <div className="mx-auto w-full border border-white px-8 lg:px-4 lg:max-w-3/4 p-4 py-6 lg:py-8">
                    ...
                    <div className="mb-6 md:mb-0">
                        <Link href="/" className="flex items-center">
                            <Image
                                ...
                                priority
                            />
                            <span className="self-center monteria text-gold text-2xl font-semibold whitespace-nowrap ">Sultan Studio</span>
                        </Link>
                    </div>
